...
namespace SqlDbEdgeDemo.Web
{
  public class Startup
  {
    ...
    {
      var ioTHubOptions = Configuration.GetSection("IoTHub").Get<IoTHubOptions>();
      services.AddSingleton(sp => ioTHubOptions);
      services.AddSingleton<IIoTHubModuleTwinService>(sp => new IoTHubModuleTwinService(ioTHubOptions));
